...
test("Board handles hit shots correctly.", () => {
    ...
    expect(board1.board[0][0]).toStrictEqual(board1.TOKENS.damaged);
    expect(board1.board[3][1]).toStrictEqual(board1.TOKENS.damaged);
    expect(board1.board[0][4]).toStrictEqual(board1.TOKENS.damaged);
});
